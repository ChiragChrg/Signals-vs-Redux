...
const WidgetContainer: React.FC = () => {
  ...
  return <div className="border-t border-slate-400">
    <p className='text-center !py-4'>1000 widgets are updated every 50ms with Redux which causes re-renders when accessing the updated state using useSelector() hook</p>
