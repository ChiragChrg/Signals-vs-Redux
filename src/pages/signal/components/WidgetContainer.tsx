...
const WidgetContainer: React.FC = () => {
  ...
  return <div className="border-t border-slate-400">
    <p className='text-center !py-4'>1000 widgets are updated every 17ms with Signals resulting in ZERO re-renders by directly painting the DOM (Bypass Virtual DOM Reconciliation)</p>
